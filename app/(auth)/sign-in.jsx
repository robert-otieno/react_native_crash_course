    ...
    <SafeAreaView className='bg-primary h-full'>
      <ScrollView contentContainerStyle={{ height: "100%" }}>
        <View className='w-full justify-center h-full px-4'>
          ...
          <Text className='text-2xl text-white mt-10 font-psemibold'>Log in to Aura</Text>
          ...
          <View className='justify-center pt-5 flex-row gap-2'>
            <Text className='text-lg text-gray-100 font-pregular'>Dont't have an account?</Text>
